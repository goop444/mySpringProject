						...
						<div class="card-body">
							...
							<form action="${cpath}/reply.do" method="post">
								...
								<div class="form-group">
									...
									<input type="text" name="title" class="form-control" value="${pvo.title}" id="title"/>	
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="writer" class="form-control" value="${mvo.name}" readonly id="writer"/>	
								</div>
